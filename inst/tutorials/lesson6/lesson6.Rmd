...
Load the `yrbss` data set into your workspace and remove any rows with missing values.
...
learnrhash::iframe_ui(
    src = "https://docs.google.com/forms/d/e/1FAIpQLScUGr9esSN3BIbJwolY-VySGQABW622NUQKOca8qJVIbAsIKg/viewform?usp=dialog", ## change link, include name
...
Each of you should be writing and running code, examining output, and answering the exercises throughout the lab. However, you only need to turn in one final lab report. To be clear, everyone submits files to lyceum, but the files can be the same within a group. Today one of you should be the main recorder of answers in the lab document. You will share this document with your teammates. Be sure to switch roles from last week so that someone else is the main recorder. 

Please note at the end of the lab document who you consulted for help.
...
Submit your Markdown document and knitted file to [Lyceum](https://lyceum.bates.edu/) as:
